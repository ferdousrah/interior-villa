...
export const ProjectsSection = (): JSX.Element => {
  ...
  const projects: Project[] = [
    {
      ...
      description:
        "Contemporary kitchen design with smart functionality, premium materials, and elegant aesthetics for modern living.",
      image: "/Qirat.avif",
      color: "#794a48",
      accent: "#794a48",
    },
  ...
  useEffect(() => {
    ...
    const handleMouseMove = (e: MouseEvent) => {
      if (!featuredWorksWrapperRef.current) return;
      const rect = featuredWorksWrapperRef.current.getBoundingClientRect();
      const x = (e.clientX - rect.left) / rect.width;
      const y = (e.clientY - rect.top) / rect.height;
    ...
    featuredWorksWrapperRef.current?.addEventListener("mousemove", handleMouseMove);
    featuredWorksWrapperRef.current?.addEventListener("mouseleave", handleMouseLeave);

    return () => {
      splitText.revert();
      featuredWorksWrapperRef.current?.removeEventListener("mousemove", handleMouseMove);
      featuredWorksWrapperRef.current?.removeEventListener("mouseleave", handleMouseLeave);
    };
  }, []);
      ...
      >
        ...
        <div className="absolute top-0 left-0 right-0 z-50 text-center pt-16 sm:pt-20 lg:pt-24">
          ...
          >
            ...
            >
              Explore our showcase of exceptional residential interior design projects that reflect
