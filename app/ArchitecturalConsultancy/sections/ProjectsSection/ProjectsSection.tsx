// components/screens/.../ProjectsSection.tsx
'use client'
...
export const ProjectsSection = (): JSX.Element => {
    ...
    (async () => {
      try {
        const res = await fetch(
          `https://interiorvillabd.com/api/projects?where[isArchitectural][equals]=true&limit=20`,
          { cache: "no-store" }
        );
        ...
        if (!cancelled) setProjects([]); // keep empty; UI still renders
      }
    })();
  ...
  // interactive hover animation for "Recent Projects"
  useEffect(() => {
              ...
              >
                <div className="flex flex-col lg:flex-row h-full">
                  ...
                  <div className="w-full lg:w-2/5 p-4 sm:p-6 md:p-8 lg:p-10 flex flex-col justify-center relative z-10 flex-shrink-0">
                    ...
                    {/* View Project as a Link (styled like the original button) */}
                    <Link
                      to={`/project-details/${project.id}`}   // <-- added project-details link
