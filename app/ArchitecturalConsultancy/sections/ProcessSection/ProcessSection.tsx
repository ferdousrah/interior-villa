  ...
  const processSteps = [
    {
      ...
      description: "We conduct thorough site analysis and develop comprehensive project requirements and specifications.",
      backgroundColor: "#FFFEF3" // Light cream/yellow
    },
    {
      step: "02", 
      title: "Conceptual Design & Development",
      description: "We create innovative design concepts that balance aesthetics, functionality, and regulatory compliance.",
      backgroundColor: "#F8FFFF" // Light cyan/blue
    },
    {
      step: "03",
      title: "Technical Documentation & Support", 
      description: "Our team provides detailed technical drawings, specifications, and ongoing project support through completion.",
