...
import { X, ChevronDown, Home as HomeIcon, User, Briefcase, FolderOpen, BookOpen, Mail, CheckCircle, MapPin, Award, Zap } from "lucide-react";
  ...
  return (
    <div className="flex flex-col w-full items-start relative bg-white overflow-x-hidden min-h-screen">
      ...
      <div ref={heroContainerRef} className="w-full relative overflow-hidden">
        <img
          ref={heroImageRef}
          className="w-full h-[60vh] md:h-[70vh] object-cover will-change-transform"
          alt="About Us Hero"
        ...
        <div className="absolute inset-0 bg-black/40 flex items-center justify-center">
          <div className="text-center text-white px-4 max-w-4xl mx-auto">
            <motion.h1 
              ...
              className="text-4xl md:text-6xl lg:text-7xl font-bold [font-family:'Fahkwang',Helvetica] mb-6"
            >
              About Us
            </motion.h1>
            <motion.p 
              ...
              className="text-lg md:text-xl lg:text-2xl [font-family:'Fahkwang',Helvetica] max-w-3xl mx-auto leading-relaxed"
            >
              Discover the story behind Interior Villa and our passion for creating extraordinary spaces
            </motion.p>
          </div>
        </div>
      </div>
      ...
      <div className="w-full">
          ...
          <div className="container mx-auto px-4 max-w-7xl">
            <div className="text-center mb-12 md:mb-20">
              ...
              <motion.p 
                ...
                viewport={{ once: true }}
                className="text-lg [font-family:'Fahkwang',Helvetica] text-[#626161] max-w-5xl mx-auto leading-relaxed"
              >
                At Interior Villa, we believe that great design is more than just aesthetics—it's about creating spaces that enhance your daily life. With years of experience and a passion for innovation, we transform ordinary spaces into extraordinary environments that reflect your personality and meet your functional needs.
              </motion.p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <Card className="bg-[#f6f8fa] border-none rounded-3xl p-8 md:p-12 text-center h-full">
                  <CardContent className="p-0">
                    <div className="text-5xl md:text-7xl font-bold [font-family:'Fahkwang',Helvetica] text-primary mb-6">
                      1000+
                    </div>
                    ...
                    <p className="text-[#626161] [font-family:'Fahkwang',Helvetica] text-base leading-relaxed">
                      Successfully delivered projects across residential and commercial spaces with exceptional quality and attention to detail.
                    </p>
                  </CardContent>
                </Card>
              </motion.div>
              ...
              >
                <Card className="bg-[#f6f8fa] border-none rounded-3xl p-8 md:p-12 text-center h-full">
                  <CardContent className="p-0">
                    ...
                    <p className="text-[#626161] [font-family:'Fahkwang',Helvetica] text-base leading-relaxed">
                      Maintaining excellence in every project with complete client satisfaction and long-lasting relationships.
                    </p>
                  </CardContent>
                </Card>
              </motion.div>
        ...
        <section className="py-16 md:py-24 lg:py-32 bg-[#f7f9fb]">
          <div className="container mx-auto px-4 max-w-7xl">
            <div className="text-center mb-12 md:mb-20">
              <motion.h2 
                initial={{ opacity: 0, y: 30 }}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                ...
                <motion.div
                  ...
                  viewport={{ once: true }}
                >
                  <Card className="bg-white border-none rounded-3xl p-6 md:p-8 h-full hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
